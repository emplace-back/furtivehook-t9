...
namespace signatures
{
	...
	constexpr auto rtl_dispatch_exception_ptr = "40 55 56 57 41 54 41 55 41 56 41 57 48 81 EC D0";
	...
	constexpr auto ret_rtl_dispatch_exception_ptr = "84 C0 74 0C 48 8B CC";
